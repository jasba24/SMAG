const ServicesActions = () => {
  return (
    <div className="flex flex-col sm:flex-row flex-wrap gap-4 px-4 py-3 max-w-lg justify-center w-full">
      <button className="flex min-w-[120px] max-w-md cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 bg-primary text-white text-lg dark:bg-slate-900 dark:border-slate-800 font-bold leading-normal tracking-[0.015em] grow">
