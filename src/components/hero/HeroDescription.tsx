  ...
  return (
    <div className="flex flex-col gap-6 @[864px]:w-1/2">
      <div className="flex flex-col gap-4 text-left">
        ...
        <h2 className="text-[#0d151b] dark:text-slate-300 text-base font-normal leading-normal @[480px]:text-lg @[480px]:font-normal @[480px]:leading-normal">
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 bg-slate-200 dark:bg-slate-700 text-[#0d151b] dark:text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-slate-300 dark:hover:bg-slate-600 transition-colors">
