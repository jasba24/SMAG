...
const Benefits = () => {
  ...
  return (
    <div id="beneficios" className="dark:bg-background-dark px-4 md:px-10 lg:px-20 xl:px-40 flex flex-1 justify-center py-10 md:py-20 scroll-mt-40">
      <div className="layout-content-container flex flex-col max-w-[960px] flex-1 gap-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-center pt-10">
          ...
          <div className="flex flex-1 flex-col gap-6 items-center lg:items-start text-center lg:text-left">
            ...
            <p className="text-background-dark dark:text-white max-w-md text-2xl text-justify">
